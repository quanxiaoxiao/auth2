...
import accountPasswordRecordSchema from './accountPasswordRecord.mjs';
...
export const AccountPasswordRecord = mongoose.model('AccountPasswordRecord', accountPasswordRecordSchema);
